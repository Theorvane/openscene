...
describe('app navigation history', () => {
  it('pushes the page being left and pops it back in order', () => {
    ...
    history = pushPageHistory(history, 'home');
    ...
    expect(second.target).toBe('home');
